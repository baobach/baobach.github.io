...
Here, probability $p$ can be thought of as the precision of a binary classifier:
...
For $(n)$ I.I.D bets per year, the annualized Sharpe ratio $(\theta[p, n])$ is given by:
$$
